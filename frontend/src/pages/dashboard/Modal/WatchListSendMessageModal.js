            ...
            <Modal title="Write a message for Bäckereifachverkäufer/in Berlin Mitte" open={props.isModalOpen} onCancel={props.handleCancel} width={1000} footer=" ">
                <div className="row write-msg">
                    <div className="col-md-3 pleft">
                        ...
                        <div className='popup-infor' style={{ "paddingTop": "10%" }}><img src="assets/img/location.svg" alt='' />{user.city} {user.country ? ',' + user.country : ''}</div>
                        <div className='popup-infor'><img src="assets/img/year.svg" alt='' />{user.year_birthday}</div>
