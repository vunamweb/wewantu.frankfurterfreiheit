            ...
            <div className="main_job">
                ...
                <div className="table-responsive" data-mdb-perfect-scrollbar="false" style={{ position: 'relative', height: '600px' }}>
                    ...
                    <table className="table">
                        ...
                        <TableBody columns={columns} tableName='JobsTable' handleClickRow={handleClickRow} tableRowEdit={tableRowEdit} tableRowRemove={tableRowRemove} tableData={filterTableData} tableDataadd={filterTableData} />
                    </table>
