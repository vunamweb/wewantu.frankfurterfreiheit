                    ...
                    <div className="p-4">
                        ...
                        <Modal isOpen={this.state.modal} centered toggle={this.toggle}>
                            ...
                            <ModalBody className="p-4">
                                <Form>
                                    <div className="mb-4">
                                        <Label className="form-label" htmlFor="addcontactemail-input">{t('t_email')}</Label>
                                        <Input type="email" className="form-control" id="addcontactemail-input" placeholder="Enter Email" />
                                    </div>
                                    <div>
                                        <Label className="form-label" htmlFor="addcontact-invitemessage-input">{t('t_invatation_message')}</Label>
                        ...
                        <div className="search-box chat-search-box">
                            <InputGroup size="lg" className="bg-light rounded-lg">
                                ...
                                <Input type="text" className="form-control bg-light " placeholder={t('t_search_users_')} />
                            </InputGroup>
                        </div>
                        {/* End search-box */}
                    </div>
                                                    ...
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <UncontrolledDropdown>
                                                            ...
                                                            <DropdownMenu className="dropdown-menu-end">
                                                                ...
                                                                <DropdownItem>{t('t_block')} <i className="ri-forbid-line float-end text-muted"></i></DropdownItem>
                                                                <DropdownItem>{t('t_remove')} <i className="ri-delete-bin-line float-end text-muted"></i></DropdownItem>
                                                            </DropdownMenu>
                                                        </UncontrolledDropdown>
                                                    </div>
                                                </li>
